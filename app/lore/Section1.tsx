      ...
      <section className="relative w-full h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6 space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
            Welcome to the Fighting Frenchie Fight Club
          </h1>

          {/* Paragraph lines */}
          <p className="text-sm md:text-base text-white/80 font-thin">
            In a world built on pressure, only the DAWGs keep standing.
          </p>

          <p className="text-sm md:text-base text-white/80 font-thin">
            They don't fight for fame. They fight because quitting isn't in
            their blood.
          </p>

          {/* CTA */}
          <p className="text-sm md:text-base text-white font-semibold tracking-wide">
            Are you ready to become a DAWG? Scroll to enter the Fight Club.
          </p>
        </div>
      </section>
    </section>
